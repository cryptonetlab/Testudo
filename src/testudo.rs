...
use crate::sparse_mlpoly::SparsePolynomial;
use crate::timer::Timer;
use crate::transcript::TranscriptWriter;
use crate::{
  constraints::R1CSVerificationCircuit,
  mipp::MippProof,
  poseidon_transcript::PoseidonTranscript,
  r1csproof::{R1CSGens, R1CSProof},
  sparse_mlpoly::SparsePolyEntry,
...
pub struct TestudoGens<E: Pairing> {
  gens_r1cs_sat: R1CSGens<E>,
  gens_r1cs_eval: R1CSCommitmentGens<E>,
}

impl<E: Pairing> TestudoGens<E> {
  /// Constructs a new `TestudoGens` given the size of the R1CS statement
...
mod tests {
  ...
  use crate::{
    ...
    poseidon_transcript::PoseidonTranscript,
    testudo::{TestudoGens, TestudoSnark},
    InputsAssignment, Instance, VarsAssignment,
  };
  use ark_ff::{BigInteger, One, PrimeField};
  use ark_groth16::prover;
  ...
  pub fn check_testudo_snark() {
    ...
    let gens = TestudoGens::<E>::new(num_cons, num_vars, num_inputs, num_cons, poseidon_params());
